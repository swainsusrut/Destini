...
The goal of this challenge is to implement the MVC design pattern and thinking about the state of your app. In addition, we will be reviewing the concept of Swift Structures and using it to separate the Model from the Controller. 
